<template>
    <div class="container h-100">
        <div >
            <info-tatuador :usuario="usuario"></info-tatuador>
        </div>

<!-- 
        <div class="" v-if="usuario.tipo_usuario != 2">
            <adicionarPublicacao class="my-3"/>
        </div> -->

        <div class="container mt-2">
            <div class="row">
                <div class="col-sm bg-dark mb-2 d-flex flex-column align-items-center p-4 text-white">
                    <img width="80" height="80" src="@/assets/img/saveIcon.png" alt="" >
                    <span>Álbuns</span>
                    <b-button class=" mt-3" @click="$router.push({name:'galeria'})
                    ">Acessar</b-button>
                </div>

                <div v-if="usuario.tipo_usuario == 3" class="col-sm bg-dark m-1 d-flex flex-column align-items-center p-4 text-white" >
                            ...
                            <b-modal :hide-footer="true" id="modal-1" title="Associar tatuadores" >
                                ...
                                <b-list-group class="my-2">
                                    ...
                                    :key="tatuadorAssociado.id">
                                            <span>{{tatuadorAssociado.usuario.nome}} • @{{tatuadorAssociado.usuario.username}}</span>
        ...
        <div>
            <listarPublicacoes :usuario="usuario" :publicacoes="publicacoes"  v-if="this.usuario.tipo_usuario == 3 || this.usuario.tipo_usuario == 1"/>
        </div>
    </div>
...
// import adicionarPublicacao from "../../reutilizaveis/adiconarPublicacao"
...
export default {
    ...
    mounted() {
            ...
            servicePublicacoes.getPublicacoesUsuario(this.usuarioId).then(resposta =>{
